...
public abstract class AbstractOAuthClient<T> {
    ...
    protected Optional<CloseableHttpClient> httpClient;
...
//    protected WebDriver driver;
    ...
    public AbstractOAuthClient(String baseUrl, CloseableHttpClient httpClient) {
...
//    }
    ...
    public Optional<CloseableHttpClient> httpClient() {
        return httpClient;
    }
